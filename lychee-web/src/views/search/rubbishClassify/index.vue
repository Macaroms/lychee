<template>
  <page-header-wrapper :title='false'>
    <a-spin :spinning='loading'>
          ...
          <a-row class='form-row' :gutter='24'>
            <a-col :lg='24' :md='12' :sm='24'>
              <a-space>
                ...
                <span v-if='type!==""' style='margin-left: 60px'>{{rubbishName}}是{{type}}</span>
              </a-space>
            </a-col>
          </a-row>
        </a-form>
      ...
      <a-row :gutter='24'>
        <a-col :md='24' :sm='24' :xl='12' style='margin-top: 20px'>
          <a-col :md='6' :sm='24'>
        ...
        <a-col :md='24' :sm='24' :xl='12' style='margin-top: 25px'>
          <a-list
            rowKey="id"
            :grid="{gutter: 24, lg: 3, md: 2, sm: 1, xs: 1}"
            :dataSource="result.data.recommendList.slice(0,6)"
            class="card-list"
            :loading="loading"
          >
